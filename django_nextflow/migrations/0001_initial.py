    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downstream', models.ManyToManyField(related_name='upstream', to='django_nextflow.Execution')),
                ('process_execution', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='data', to='django_nextflow.processexecution')),
            ],
        ),
    ]
