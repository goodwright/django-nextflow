...
class PipelineCreationTests(TestCase):
    ...
    def test_pipeline_creation(self):
        ...
        self.assertEqual(pipeline.order, 1)
    

    def test_pipeline_order(self):
        p1 = mixer.blend(Pipeline, order=3)
        p2 = mixer.blend(Pipeline, order=1)
        p3 = mixer.blend(Pipeline, order=2)
...
class PipelineRunningTests(TestCase):
    ...
    def test_can_run(self, *mocks):
        ...
        mocks[-4].assert_called_with(nf_execution, "1000", pipeline, {"param1": "X", "param2": "Y"}, {"param3": 100}, {"param4": 50})
...
class PipelineRunningAndUpdatingTests(TestCase):
    ...
    def test_can_run_and_update(self, *mocks):
        ...
        mocks[-4].assert_any_call(execution1, "1000", pipeline, {"param1": "X", "param2": "Y"}, {"param3": 100}, {"param4": 50})
        mocks[-4].assert_any_call(execution2, "1000", pipeline, {"param1": "X", "param2": "Y"}, {"param3": 100}, {"param4": 50})
        self.assertEqual(set(execution.upstream_data.all()), set(Data.objects.all()))
